...
const float maxRitmoCardiaco = 120.0;  // Valor máximo de ritmo cardíaco
const float minRitmoCardiaco = 50.0;   // Valor mínimo de ritmo cardíaco
const float maxTempCorporal = 37.5;    // Valor máximo de temperatura corporal
const float minTempCorporal = 36.0;    // Valor mínimo de temperatura corporal
...
<body>
  ...
  <script>
    ...
    // Mostrar alertas visuales y reproducir sonido si es necesario
