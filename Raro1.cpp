...
const char* ssid = "your_SSID";     // Reemplaza "your_SSID" por tu SSID
const char* password = "your_PASS"; // Reemplaza "your_PASS" por tu contraseña
...
void checkWiFiConnection() {
  WiFiManager wifiManager;
  if (!wifiManager.autoConnect("Chap config portal", "password")) {
...
void checkAndResetConfigPortal() {
  if (digitalRead(TRIGGER_PIN) == LOW) {
    ...
    Serial.println("Conectado a la red WiFi con la dirección IP:");  // Mostrar dirección IP
    Serial.println(WiFi.localIP());
  }
}
